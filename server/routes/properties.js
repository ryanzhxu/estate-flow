...
const properties = [
    ...
    },
    {
        ...
        amenities: ["Pool", "Washing Machine", "Dryer"],
        photos: [
            "https://cache-w12.housesigma.com/file/pix-rebgv/262723843/bf7ba_1.jpg?36285a70",
        ],
        tenants: [
            {
                firstName: "Mary",
    ...
    },
    {
        ...
        amenities: ["Pool", "Washing Machine", "Dryer"],
        photos: [
            "https://cache-w13.housesigma.com/file/pix-rebgv/262810431/b418d_1.jpg?fd6e3cc8",
        ],
        tenants: [
            {
                firstName: "Mary",
    ...
    },
    {
        ...
        amenities: ["Pool", "Washing Machine", "Dryer"],
        photos: [
            "https://cache-w12.housesigma.com/file/pix-rebgv/262808298/c6d7f_16.jpg?5fa1207b",
        ],
        tenants: [
            {
                firstName: "Mary",
    ...
    },
    {
        ...
        amenities: ["Pool", "Washing Machine", "Dryer"],
        photos: [
            "https://cache-w10.housesigma.com/file/pix-rebgv/262781211/be877_3.jpg?c3e5bf42",
        ],
        tenants: [
            {
                firstName: "Mary",
...
router.post('/', (req, res, next) => {
    ...
    const property = { id: uuid(), type: type, name: name, address: address, bed: bed, bath: bath, description: description, rent: rent, amenities: amenities, photos: photos, tenants: tenants };
