    ...
    return (
      <div key={section}>
        ...
        {Object.keys(inputs[section]).map((input) => {
          ...
          if (field.hasOwnProperty("options")) { // basically just for Property Type, anything with Options 
            return (
              <div key={input} className = "inputOptions">
                <label htmlFor={input} className = "optionsLabel">{field.label}</label>
          ...
          if (field.hasOwnProperty("file")) { // just for photos
            return (
              <div key={input} className = "inputFile">
                <label htmlFor={input} className = "fileLabel">{field.label}</label>
                <br></br>
          ...
          return (
            <div key={input} className = "inputText">
              <label htmlFor={input} className = "textLabel">{field}</label>
              <br></br>
...
const PropertyInputForm = ({ inputs }) => { // submit doesnt do anything yet
  return (
