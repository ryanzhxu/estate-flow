    ...
    return (
        <div>
            <div onClick={() => setIsOpen(true)} className="list-group-item list-group-item-action py-2 lh-tight tenant-card">
                <h6 className="mb-0">{tenant.firstName} {tenant.middleName ? `${tenant.middleName.charAt(0)}.`: ""} {tenant.lastName}</h6>
            ...
            <Modal show={isOpen} onHide={() => setIsOpen(false)} centered>
                ...
                <Modal.Body className="modal-content">
                    <div className="row">
                        <p className="col-sm-4"><strong>Name</strong></p>
                        <p className="col-sm-8">
                            {tenant.firstName} {tenant.middleName ? `${tenant.middleName.charAt(0)}.` : ""} {tenant.lastName}
                        </p>
                    </div>
                    <div className="row">
                        <p className="col-sm-4"><strong>Phone</strong></p>
                        <p className="col-sm-8">{tenant.phoneNumber}</p>
                    </div>
                    <div className="row">
                        <p className="col-sm-4"><strong>Email</strong></p>
                        <p className="col-sm-8">{tenant.email}</p>
                    </div>
                    <div className="row">
                        <p className="col-sm-4"><strong>Lease Term</strong></p>
                        <p className="col-sm-8">12 months</p>
                    </div>
                    <div className="row">
                        <p className="col-sm-4"><strong>Rent</strong></p>
